...
;
        ...
        JRZ PT1
        MV Y,OTOTBL1
        MV X,MUSIC1L ; ｽﾀｰﾄ (ﾅｶﾞｲ)
        CALLF MPLAY
        JR PT2
PT1:
        MV Y,OTOTBL1
        MV X,MUSIC1S ; ｽﾀｰﾄ (ﾐｼﾞｶｲ)
        CALLF MPLAY
PT2:
        MV I,65000
        WAIT
...
;   7 :  ﾏﾄﾞ 4
;   8 :  ｵｼﾞｬﾏ
;   9 :  ﾏﾄﾞ ｱｷ  ﾃﾞ ﾃｯｺﾂ ｵﾄｽ
;  10 :  ﾏﾄﾞ ｱｷ ﾃﾞ ｶﾝﾊﾞﾝ ﾋﾀﾞﾘ
;  11 :  ﾏﾄﾞ ｱｷ ﾃﾞ ｶﾝﾊﾞﾝ ﾏﾝﾅｶ
;  12 :  ﾏﾄﾞ ｱｷﾃﾞ  ｶﾝﾊﾞﾝ ﾐｷﾞ
;  13 :  UFO
;  14 :  ｸﾓ
;  15 :  END
;***********************
...
;
SPCHR:
		DB	003H,01AH,00FH,01AH,003H,000H,000H,000H ; ｱ (ﾆﾝｹﾞﾝ)
		DB	01FH,01FH,000H,004H,004H,000H,000H,000H ; ｲ (I-)
		DB	000H,01FH,01FH,015H,015H,011H,000H,000H ; ｳ (E)
		DB	004H,00FH,01FH,00FH,004H,000H,000H,000H ; ｴ (ｼﾀ ﾔｼﾞﾙｼ)
		DB	004H,01EH,01FH,01EH,004H,000H,000H,000H ; ｵ (ｳｴ ﾔｼﾞﾙｼ)
		DB	00EH,00EH,01FH,00EH,004H,000H,000H,000H ; ｶ (ﾐｷﾞ ﾔｼﾞﾙｼ)
		DB	004H,00EH,01FH,00EH,00EH,000H,000H,000H ; ｷ (ﾋﾀﾞﾘ ﾔｼﾞﾙｼ)
		DB	01FH,011H,000H,000H,000H,000H,000H,000H ; ｸ [
		DB	004H,004H,01FH,004H,004H,000H,000H,000H ; ｹ +
		DB	000H,000H,000H,011H,01FH,000H,000H,000H ; ｺ ]
		DB	00AH,00AH,00AH,00AH,00AH,000H,000H,000H ; ｻ =
		DB	00EH,011H,015H,015H,00EH,000H,000H,000H ; ｼ (C)
		DB	00AH,01FH,015H,00AH,014H,000H,000H,000H ; ｽ &
...
ADAT0: DB   'ｱKEY FUNCTIONｱ',0
ADAT1: DB   '   LEFT              RIGHT',0
ADAT2: DB   '  ｸSHIFTｺ     ｵ      ｸ ｻ ｺ',0
ADAT3: DB   '  ｸCTRL ｺ   ｷ ｱ ｶ    ｸ ｹ ｺ',0
ADAT4: DB   'ｸBASICｺ QUIT   ｼ1994 BUGSOFT',0
;            123456
UFOC1:
        DB 14
