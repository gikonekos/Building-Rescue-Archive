...
;
SPCHR:
		DB	003H,01AH,00FH,01AH,003H,000H,000H,000H ; ± (∆›πﬁ›)
		DB	01FH,01FH,000H,004H,004H,000H,000H,000H ; ≤ (I-)
		DB	000H,01FH,01FH,015H,015H,011H,000H,000H ; ≥ (E)
		DB	004H,00FH,01FH,00FH,004H,000H,000H,000H ; ¥ (º¿ ‘ºﬁŸº)
		DB	004H,01EH,01FH,01EH,004H,000H,000H,000H ; µ (≥¥ ‘ºﬁŸº)
		DB	00EH,00EH,01FH,00EH,004H,000H,000H,000H ; ∂ (–∑ﬁ ‘ºﬁŸº)
		DB	004H,00EH,01FH,00EH,00EH,000H,000H,000H ; ∑ (À¿ﬁÿ ‘ºﬁŸº)
		DB	01FH,011H,000H,000H,000H,000H,000H,000H ; ∏ [
		DB	004H,004H,01FH,004H,004H,000H,000H,000H ; π +
		DB	000H,000H,000H,011H,01FH,000H,000H,000H ; ∫ ]
		DB	00AH,00AH,00AH,00AH,00AH,000H,000H,000H ; ª =
		DB	00EH,011H,015H,015H,00EH,000H,000H,000H ; º (C)
		DB	00AH,01FH,015H,00AH,014H,000H,000H,000H ; Ω &
...
ADAT2: DB   '  ∏SHIFT∫     µ      ∏ ª ∫',0
ADAT3: DB   '  ∏CTRL ∫   ∑ ± ∂    ∏ π ∫',0
ADAT4: DB   '∏BASIC∫ QUIT   º1994 BUGSOFT',0
;            123456
UFOC1:
        DB 14
