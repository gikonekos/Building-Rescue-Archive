...
ALPDAT:
; c0682
		DB 01EH,009H,009H,01FH,01EH; c0683
		DB 000H,000H,000H
		DB 01FH,01FH,015H,015H,00AH; c0684
		DB 000H,000H,000H
		DB 00EH,01FH,011H,011H,011H; c0685
		DB 000H,000H,000H
		DB 01FH,011H,011H,01FH,00EH; c0686
		DB 000H,000H,000H
		DB 01FH,01FH,015H,015H,011H; c0687
		DB 000H,000H,000H
		DB 01FH,01FH,005H,005H,001H; c0688
		DB 000H,000H,000H
		DB 00EH,01FH,011H,015H,01DH; c0689
		DB 000H,000H,000H
		DB 01FH,01FH,004H,01FH,01FH; c0690
		DB 000H,000H,000H
		DB 000H,000H,01FH,01FH,000H; c0691
		DB 000H,000H,000H
		DB 011H,011H,01FH,00FH,001H; c0692
		DB 000H,000H,000H
		DB 01FH,01FH,004H,00AH,011H; c0693
		DB 000H,000H,000H
		DB 01FH,01FH,010H,010H,010H; c0694
		DB 000H,000H,000H
		DB 01FH,002H,004H,002H,01FH; c0695
		DB 01FH,000H,000H
		DB 01FH,01FH,006H,008H,01FH; c0696
		DB 000H,000H,000H
		DB 00EH,01FH,011H,011H,00EH; c0697
		DB 000H,000H,000H
		DB 01FH,01FH,005H,005H,002H; c0698
		DB 000H,000H,000H
		DB 00EH,019H,015H,00FH,016H; c0699
		DB 000H,000H,000H
		DB 01FH,01FH,009H,01FH,016H; c0700
		DB 000H,000H,000H
		DB 016H,017H,01DH,01DH,009H; c0701
		DB 000H,000H,000H
		DB 001H,001H,01FH,01FH,001H; c0702
		DB 001H,000H,000H
		DB 00FH,01FH,010H,01FH,00FH; c0703
		DB 000H,000H,000H
		DB 007H,00FH,018H,00FH,007H; c0704
		DB 000H,000H,000H
		DB 00FH,010H,00FH,010H,01FH; c0705
		DB 00FH,000H,000H
		DB 01BH,007H,004H,01CH,01BH; c0706
		DB 000H,000H,000H
		DB 003H,007H,01CH,01CH,007H; c0707
		DB 003H,000H,000H
		DB 019H,01DH,01FH,017H,013H; c0708
		DB 000H,000H,000H
; c0709
SPCHR:
		DB 003H,01AH,00FH,01AH,003H; c0710
		DB 000H,000H,000H
		DB 01FH,01FH,000H,004H,004H; c0711
		DB 000H,000H,000H
		DB 000H,01FH,01FH,015H,015H; c0712
		DB 011H,000H,000H
		DB 004H,00FH,01FH,00FH,004H; c0713
		DB 000H,000H,000H
		DB 004H,01EH,01FH,01EH,004H; c0714
		DB 000H,000H,000H
		DB 00EH,00EH,01FH,00EH,004H; c0715
		DB 000H,000H,000H
		DB 004H,00EH,01FH,00EH,00EH; c0716
		DB 000H,000H,000H
		DB 01FH,011H,000H,000H,000H; c0717
		DB 000H,000H,000H
		DB 004H,004H,01FH,004H,004H; c0718
		DB 000H,000H,000H
		DB 000H,000H,000H,011H,01FH; c0719
		DB 000H,000H,000H
		DB 00AH,00AH,00AH,00AH,00AH; c0720
		DB 000H,000H,000H
		DB 00EH,011H,015H,015H,00EH; c0721
		DB 000H,000H,000H
		DB 00AH,01FH,015H,00AH,014H; c0722
		DB 000H,000H,000H
