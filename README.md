...
The **grayscale effect** is generated by alternating **multiple virtual frame buffers** with a **1:2 timing ratio**. The slow response of the STN LCD blends the frames, producing several apparent brightness levels **without spatial dithering**.

*This technique relies on the relatively slow response time of early STN LCD panels*.

![PC-E500 pseudo grayscale title screen](docs/OpeningDemo.png)
